...
TEXTBOX_FONT = pygame.font.Font('freesansbold.ttf', 32)
TEXTBOX_X_MARGIN = 10
TEXTBOX_Y_MARGIN = 5
...
NOTIFICATION_FONT = pygame.font.Font('freesansbold.ttf', NOTIFICATION_FONT_SIZE)
...
# Menu Box Settings
MENU_BOX_FONT_SIZE = 36
MENU_FONT = pygame.font.Font('freesansbold.ttf', MENU_BOX_FONT_SIZE)
MENU_BOX_WIDTH = 175
MENU_BOX_HEIGHT = 300
MENU_BOX_POSITION_TOP = 200
MENU_BOX_POSITION_LEFT = 100
MENU_BOX_TEXT_MARGIN = 6
MENU_BOX_POINTER_WIDTH = 20

# MAP SETTINGS
STARTING_MAP = "firstmap.tmx"
TILE_WIDTH = 32
TILE_HEIGHT = 32
